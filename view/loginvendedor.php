...
<head>
    ...
    <title>Login - Vendedor Pizzaria</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="login-container">
        ...
        <form action="../model/vendedorlogin.php" method="POST">
            <label for="cxloginven">Usuário:</label>
            <input type="text" id="cxloginven" name="cxloginvendedor">
            
            <label for="cxsenhaven">Senha:</label>
            <input type="password" id="cxsenhaven" name="cxsenhavendedor">
